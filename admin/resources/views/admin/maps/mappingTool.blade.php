...
@section('title', 'Maps - Mapping')

@section('content')
    <!-- Page Heading -->
    <div class="d-sm-flex align-items-center justify-content-between mb-10">
        <h1 class="h1 mb-0 text-gray-800">Maps - Mapping</h1>
    </div>
        ...
        @if ($listsRobot->count() > 0)
            @foreach ($listsRobot as $robot)
                <div class="col-6 col-md-6 col-lg-4">
                    <a href="{{route('admin.maps.mapping.controllerMapping', $robot)}}" class="text-center" style="text-decoration: none;">
